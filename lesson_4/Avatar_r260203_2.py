...
coordinates_1 = (cut_range, 0, red.width, red.height)
red_cropped_1 = red.crop(coordinates_1)
coordinates_2 = (cut_range/2, 0, image.width-cut_range/2, red.height)
red_cropped_2 = red.crop(coordinates_2)
red_overlay = Image.blend(red_cropped_1, red_cropped_2, 0.8)

coordinates_1 = (0, 0, blue.width-cut_range, blue.height)
blue_cropped_1 = blue.crop(coordinates_1)
coordinates_2 = (cut_range/2, 0, image.width-cut_range/2, blue.height)
